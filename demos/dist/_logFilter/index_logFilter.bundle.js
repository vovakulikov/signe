...
function getRation(img, width) {
    ...
    } else if (img.height > height) ratio = height / img.height;
    ...
    _createClass(Controller, [{
        ...
        value: function uploadImage(evt) {
            ...
            this.store.loadImage(evt).then(function (picture) {
                _this.view.render('firstPaint', picture);
        ...
        value: function processingImage(data) {
            var pixels = this.store.processingImage(data);
...
var Store = function () {
    ...
    _createClass(Store, [{
        ...
        value: function loadImage(evt) {
            ...
            return (0, _helpers.fileSelect)(path).then(function (data) {
    ...
    _createClass(View, [{
        ...
        value: function bindStartFiltering(handler) {
            ...
            this.startEffect.addEventListener('click', function (e) {
                var information = (0, _helpers.getInfoCanvas)(_this.canvas);
                handler(information);
            });
        }
    }, {
        key: 'dragFieldHide',
        value: function dragFieldHide() {
        ...
        value: function render(type, picture) {
            ...
            var action = {
                'firstPaint': function firstPaint() {
                    _this2.dragFieldHide();
                    console.log(_this2.canvas.parentNode.offsetWidth);
...
var ExifReader = __webpack_require__(8).ExifReader;
...
var process = __webpack_require__(15);
var exif = __webpack_require__(7);
var toArray = __webpack_require__(6);
var rotate = __webpack_require__(16);
var resize = __webpack_require__(11);
var urlToImage = __webpack_require__(12);
var size = {
  'image/png': __webpack_require__(14),
  'image/jpeg': __webpack_require__(13)
};

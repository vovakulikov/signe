...
var Filters = function () {
    function Filters(imageData, logoMark) {
        ...
        this.masks = {
            ...
            '7': [[0, 0, 1, 0, 0], [0, 1, 2, 1, 0], [1, 2, -16, 2, 1], [0, 1, 2, 1, 0], [0, 0, 1, 0, 0]],
            '9': [[0, 1, 2, 4, 4, 4, 2, 1, 0], [1, 3, 7, 10, 11, 10, 7, 3, 1], [2, 7, 11, 6, 1, 6, 11, 7, 2], [4, 10, 6, -24, -48, -24, 6, 10, 4], [4, 11, 1, -48, -83, -48, 1, 11, 4], [4, 10, 6, -24, -48, -24, 6, 10, 4], [2, 7, 11, 6, 1, 6, 11, 7, 2], [1, 3, 7, 10, 11, 10, 7, 3, 1], [0, 1, 2, 4, 4, 4, 2, 1, 0]],
            '11': [[0, 0, 0, -1, -1, -2, -1, -1, 0, 0, 0], [0, 0, -2, -4, -8, -9, -8, -4, -2, 0, 0], [0, -2, -7, -15, -22, -23, -22, -15, -7, -2, 0], [-1, -4, -15, -24, -14, -1, -14, -24, -15, -4, -1], [-1, -8, -22, -14, 52, 103, 52, -14, -22, -8, -1], [-2, -9, -23, -1, 103, 180, 103, -1, -23, -9, -2], [-1, -8, -22, -14, 52, 103, 52, -14, -22, -8, -1], [-1, -4, -15, -24, -14, -1, -14, -24, -15, -4, -1], [0, -2, -7, -15, -22, -23, -22, -15, -7, -2, 0], [0, 0, -2, -4, -8, -9, -8, -4, -2, 0, 0], [0, 0, 0, -1, -1, -2, -1, -1, 0, 0, 0]]
        };
        /*
                this.LoG_mask = [
                    [0,1,2,4,4,4,2,1,0],
    ...
    _createClass(Filters, [{
        ...
        key: 'overlayMask',
        value: function overlayMask(x, y, maskSize) {
            var mask = this.masks[maskSize];
            var centerMask = (mask.length - 1) / 2;
            var relay = 0;
        ...
        key: 'LoGfilter',
        value: function LoGfilter(maskSize) {
            var i = void 0,
                j = void 0;
            var r = [];
            for (i = 0; i < this._widthImage; i++) {
                ...
                for (j = 0; j < this._heightImage; j++) {
                    var response = this.overlayMask(i, j, maskSize);
